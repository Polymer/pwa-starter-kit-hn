...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_polymer_polymer_lib_elements_dom_repeat_js__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__reducers_items_js__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_store_js__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__hn_comment_element_js__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__actions_items_js__ = __webpack_require__(39);
...
class HnItemElement extends __WEBPACK_IMPORTED_MODULE_0__node_modules_polymer_polymer_polymer_element_js__["a" /* Element */] {
  static get template() {
    return `
    <h1>Item View</h1>
  ...
  constructor() {
    super();
    __WEBPACK_IMPORTED_MODULE_4__modules_store_js__["a" /* store */].subscribe(() => this.update());
    this.update();
  }

  update() {
    const state = __WEBPACK_IMPORTED_MODULE_4__modules_store_js__["a" /* store */].getState();
  ...
  _reload() {
    __WEBPACK_IMPORTED_MODULE_4__modules_store_js__["a" /* store */].dispatch(Object(__WEBPACK_IMPORTED_MODULE_8__actions_items_js__["d" /* fetchItem */])(this.item));
  }
}
