...
exports.urlSearchParamsSelector = exports.pageSelector = exports.splitPathnameSelector = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _location2 = __webpack_require__(6);
...
var location = function location() {
  ...
  switch (action.type) {
    case _location2.UPDATE_LOCATION:
      var _location = action.location;
...
var pathnameSelector = function pathnameSelector(state) {
  return state.location.pathname;
};

var splitPathnameSelector = exports.splitPathnameSelector = (0, _index.createSelector)(pathnameSelector, function (pathname) {
  return pathname ? pathname.slice(1).split('/') : [];
});

var pageSelector = exports.pageSelector = (0, _index.createSelector)(splitPathnameSelector, function (splitPath) {
  switch (splitPath[0]) {
    case '':
    case 'new':
    case 'ask':
...
var urlSearchParamsSelector = exports.urlSearchParamsSelector = (0, _index.createSelector)(searchSelector, function (search) {
  if ('URLSearchParams' in window) {
    return new URLSearchParams(search);
  } else {
    return search.slice(1).split('&').reduce(function (map, s) {
      map.set.apply(map, _toConsumableArray(s.split('=').map(window.decodeURIComponent)));
      return map;
    }, new Map());
  }
});
...
exports.updateLocation = exports.UPDATE_LOCATION = undefined;
...
var updateLocation = exports.updateLocation = function updateLocation(location) {
  return function (dispatch, getState) {
    ...
    switch ((0, _location.pageSelector)(getState())) {
      case 'list':
        Promise.all/* import() */([__webpack_require__.e(1), __webpack_require__.e(0), __webpack_require__.e(4)]).then(__webpack_require__.bind(null, 30)).then(function (module) {
          dispatch(module.fetchListIfNeeded(module.currentListSelector(getState())));
        });
        break;
      case 'user':
        Promise.all/* import() */([__webpack_require__.e(0), __webpack_require__.e(3), __webpack_require__.e(2)]).then(__webpack_require__.bind(null, 31)).then(function (module) {
          dispatch(module.fetchUserIfNeeded(module.currentUserSelector(getState())));
        });
        break;
      case 'item':
        Promise.all/* import() */([__webpack_require__.e(1), __webpack_require__.e(0), __webpack_require__.e(5), __webpack_require__.e(2)]).then(__webpack_require__.bind(null, 32)).then(function (module) {
...
var sharedStyles = exports.sharedStyles = "\n<style>\n  :host {\n    color: #666;\n  }\n\n  a {\n    color: #000;\n  }\n\n  button {\n    padding: 4px;\n    background: none;\n    border: 2px solid;\n    font-weight: bold;\n  }\n</style>\n";
...
var compose = window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || _compose2.default;
  ...
  return function (origReducer, preloadedState) {
    ...
    return _extends({}, nextStore, {
      addReducers: function addReducers(newReducers) {
        this.replaceReducer((0, _combineReducers2.default)(lazyReducers = _extends({}, lazyReducers, newReducers)));
      }
    });
  };
}

var store = exports.store = (0, _createStore2.default)(function (state, action) {
  return state;
}, compose(lazyReducerEnhancer, (0, _applyMiddleware2.default)(_index2.default)));
...
var connect = exports.connect = function connect(store) {
    ...
    return function (_baseElement) {
      ...
      function _class() {
        ...
        store.subscribe(function () {
          return _this.update(store.getState());
        });
        _this.update(store.getState());
        return _this;
      }
...
var _propertyAccessors = __webpack_require__(22);

var _templateStamp = __webpack_require__(23);
...
exports.HnAppElement = undefined;
...
var _location3 = __webpack_require__(6);
...
(0, _router.installRouter)(function () {
  return _store.store.dispatch((0, _location3.updateLocation)(window.location));
});

var HnAppElement = exports.HnAppElement = function (_connect) {
  _inherits(HnAppElement, _connect);

  function HnAppElement() {
    _classCallCheck(this, HnAppElement);

    return _possibleConstructorReturn(this, (HnAppElement.__proto__ || Object.getPrototypeOf(HnAppElement)).apply(this, arguments));
  }

  _createClass(HnAppElement, [{
    key: 'update',
    value: function update(state) {
      this.setProperties({
        page: (0, _location.pageSelector)(state)
      });
    }
  }], [{
    key: 'template',
...
var _styleGather = __webpack_require__(20);

var _resolveUrl = __webpack_require__(2);

var _domModule = __webpack_require__(21);
...
var installRouter = exports.installRouter = function installRouter(locationUpdatedCallback) {
  ...
  window.addEventListener('popstate', function () {
    return locationUpdatedCallback();
  });
  locationUpdatedCallback();
};
